...
public:
	...
	__vec_global_inl Vec_(const std::initializer_list<value_t> _list) : _Base(_list) {}

	template<typename _RvalTy>
	__vec_global_inl Vec_& operator= (const _RvalTy& _rval)
...
template<typename _Ty> class Vec3_ : public Vec_<_Ty, 3>
{
...
public:
	...
	template<typename _RvalTy>
	__vec_global_inl Vec3_& operator= (const _RvalTy& _rval)
...
template<typename _Ty> class Vec4_ : public Vec_<_Ty, 4>
{
